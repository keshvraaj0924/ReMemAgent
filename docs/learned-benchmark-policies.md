...
This parser is intentionally conservative: free-form reasoning without a canonical action is rejected instead of being silently passed to the environment.
